...
public class SignupActivity extends BaseActivity implements DiscoveryListener,
    ...
    protected void onCreate(final Bundle savedInstanceState)
    {
        ...
        getTokenButton.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                ...
                mobileConnectAndroidView.attemptDiscovery(msisdn, null, null, requestOptions, SignupActivity.this);
            }
        });
