...
public class DiscoveryTest extends ActivityTestRule<MainActivity> {
    ...
    public void test_discovery_invalid_client_id() throws FileNotFoundException, InterruptedException {
        ...
        MobileConnectConfig mobileConnectConfig = new MobileConnectConfigCreator(mActivity.getApplicationContext()).createConfigClientId("Invalid");
    ...
    public void test_discovery_invalid_client_secret() throws FileNotFoundException, InterruptedException {
        ...
        MobileConnectConfig mobileConnectConfig = new MobileConnectConfigCreator(mActivity.getApplicationContext()).createConfigClientSecret("Invalid");
        MobileConnectRequestOptions requestOptions = createOptions(mobileConnectConfig);
        mobileConnectAndroidInterface.attemptDiscovery(null,
                dataReader.getMcc(),
                dataReader.getMnc(),
    ...
    public void test_discovery_UOI_flow() throws FileNotFoundException, InterruptedException {
        ...
        DiscoveryResponseData expResp = null;
        try {
            expResp = dataReader.getDiscoveryResponseDataWithExpectedParameters(GsmaDataReader.DiscoveryItems.OperatorG, actResp.getResponse().getClientId(),
                        actResp.getResponse().getClientSecret(),
                        actResp.getSubscriberId(), actResp.getTtl()).getResponseData();
        } catch (IOException | JsonDeserializationException e) {
            e.printStackTrace();
    ...
    @Test
    public void test_discovery_valid_msisdn() throws FileNotFoundException, InterruptedException {
    ...
    @Test
    public void test_discovery_invalid_msisdn() throws FileNotFoundException, InterruptedException {

        MobileConnectRequestOptions requestOptions = createOptions();
        mobileConnectAndroidInterface.attemptDiscovery("invalid",
                null,
                null,
                requestOptions,
                new IMobileConnectContract.IMobileConnectCallback()
                {
                                                   ...
                                                   mobileConnectStatus)
                    {
                        gotResponse = true;
                        try {
                            assertEquals(dataReader.getErrorInvalidMsisdn().getError(), mobileConnectStatus.getErrorCode());
                        assertEquals(dataReader.getErrorInvalidMsisdn().getErrorDescription(), mobileConnectStatus.getErrorMessage());
                        } catch (IOException | JsonDeserializationException e) {
                            e.printStackTrace();
                        }
                    }
    ...
    public void test_discovery_null_redirect() throws FileNotFoundException, InterruptedException {
        dataReader = new GsmaDataReader(mActivity.getApplicationContext());
        MobileConnectConfig mobileConnectConfig = new MobileConnectConfigCreator(mActivity.getApplicationContext()).createConfigRedirectUri("");
        MobileConnectRequestOptions requestOptions = createOptions(mobileConnectConfig);
        mobileConnectAndroidInterface.attemptDiscovery(null,
                dataReader.getMcc(),
                dataReader.getMnc(),
